...
I would just like to preface this readme with the fact that Projects is not my own idea. It is a fork of the very popular Projects repository originally created by Karan Goel. After forking I removed any files that had solved any problems, as well as things I regarded as fluff, such as the MIT open license and contributing sections, since this is not the original repository, nor will it have any code but my own. While the original set out to do everything in Python, for no particular reason other than to learn the language, I wish to solve all the problems listed below in as many different languages as possible to practice my skills in said languages. Again, this is not the original repository created by Karan Goel. The original can be found [**here**](https://github.com/karan/Projects).
